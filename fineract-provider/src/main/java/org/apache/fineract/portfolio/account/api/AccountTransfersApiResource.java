...
public class AccountTransfersApiResource {
    ...
    public String create(@HeaderParam("source") String source, @Parameter(hidden = true) final String apiRequestBodyAsJson) {

        final CommandWrapper commandRequest = new CommandWrapperBuilder().createAccountTransfer().withJson(apiRequestBodyAsJson)
